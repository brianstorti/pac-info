...
angular.module('pacApp')
  .directive('pacPorRegiaoInvestimentos', ['vega', 'chartHeight', function (vega, chartHeight) {
    return {
      replace: true,
      restrict: 'A',
      link: function (scope, iElement) {
        ...
        function drawChart(){
          ...
          var data = {
            table: [
              { 'x': 'São Paulo', 'y': 100 },
              { 'x': 'Rio de Janeiro', 'y': 80 },
              { 'x': 'Minas Gerais', 'y': 60 },
              { 'x': 'Espirito Santos', 'y': 40 }
            ]
          };
              ...
              },
              {
                ...
                'properties': {
                  'enter': {
                    ...
                    'text': {'field': 'data.y'},
                    'align': {'value': 'left'},
                    'dx': {'value': (width/data.table.length), 'mult': 0.35},
                    'fontSize': { 'value': 14 }
                  }
                }
              }
